...
# python facetracking.py --face cascades/haarcascade_frontalface_default.xml --video video/adrian_face.mov
...
while True:
	...
	# TODO: if you have a low quality camera, please increase the width, say 600 or more
