...
# For testing step
def test_model(test_loader, model_path, num_classes, k=1):
...
if __name__ == "__main__":
    # Data preparation
    _, _, test_loader = prepare_custom_dataset(input_size=(224, 224), batch_size=64, train_dir='./data/custom/train', val_dir='./data/custom/val', test_dir='./data/custom/test')

    # Testing
    test_model(test_loader, num_classes=2, model_path='runs/train_1/best_model.pt')
